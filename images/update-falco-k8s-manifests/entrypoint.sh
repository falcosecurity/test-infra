...
create_pr() {
    ...
    body='Updating deployment files (automatically generated by helm template). Made using the [update-falco-k8s-manifests](https://github.com/falcosecurity/test-infra/blob/main/config/jobs/aws/update-falco-k8s-manifests/update-falco-k8s-manifests.yaml) ProwJob. Do not edit this PR.\n\n/kind update\n\n/area manifests'
