...
create_pr() {
    nchanges=$(git status --porcelain=v1 -- "kubernetes/${HELM_CHART_NAME}" | wc -l)
    ...
    title="update(kubernetes): ${HELM_CHART_NAME} deployment files"
    git add "kubernetes/${HELM_CHART_NAME}"
    ...
    body=$'Updating deployment files generated by [update-falco-k8s-manifests](https://github.com/falcosecurity/test-infra/tree/master/images/update-falco-k8s-manifests). Do not edit this PR.\n\n/kind update\n\n/area manifests'
