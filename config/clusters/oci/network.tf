...
resource "oci_core_security_list" "kubernetes_api" {
  # checkov:skip=CKV_OCI_17:OKE API traffic uses stateful rules and tracked return traffic.
  compartment_id = var.compartment_ocid
...
resource "oci_core_security_list" "service_lb" {
  # checkov:skip=CKV_OCI_17:OKE load balancer traffic uses stateful rules and tracked return traffic.
  compartment_id = var.compartment_ocid
...
resource "oci_core_security_list" "node" {
  # checkov:skip=CKV_OCI_17:OKE node traffic uses stateful rules and tracked return traffic.
  compartment_id = var.compartment_ocid
