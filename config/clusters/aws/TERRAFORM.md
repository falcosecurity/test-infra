...
| [aws_ecr_repository.sync_charts](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ecr_repository) | resource |
...
| [aws_ecr_repository_policy.sync_charts](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/ecr_repository_policy) | resource |
...
| <a name="input_eks_cluster_version"></a> [eks\_cluster\_version](#input\_eks\_cluster\_version) | Kubernetes version of the EKS control plane. | `string` | `"1.31"` | no |
...
| <a name="input_eks_node_group_version"></a> [eks\_node\_group\_version](#input\_eks\_node\_group\_version) | Kubernetes version of the EKS managed node groups. | `string` | `"1.30"` | no |
