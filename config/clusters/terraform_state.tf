...
resource "aws_s3_bucket_acl" "falco-test-infra-state" {
  bucket = aws_s3_bucket.falco-test-infra-state.id
  acl    = "private"
}

resource "aws_s3_bucket_versioning" "falco-test-infra-state" {
  bucket = aws_s3_bucket.falco-test-infra-state.id
...
resource "aws_s3_bucket_server_side_encryption_configuration" "falco-test-infra-state" {
  bucket = aws_s3_bucket.falco-test-infra-state.id
